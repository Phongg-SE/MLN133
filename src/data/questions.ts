export interface Question {
  ...
  explanation: string;
  pageRef?: string;
  advisor?: 'C.Mác' | 'Ph.Ăngghen' | 'V.I.Lênin';
}

export const LEVEL_NAMES: Record<number, { name: string; subtitle: string; targetXp: number; timerPerQ: number; env: string }> = {
  1: {
    name: "Màn 1: Công xưởng Thế kỷ XIX",
    subtitle: "Chương 1 & 2: Nhập môn CNXH Khoa học & Sứ mệnh Giai cấp Công nhân",
    targetXp: 300,
    timerPerQ: 30,
    env: "Bánh răng công nghiệp, nhà máy, ống khói & đường ray xe lửa",
  },
  2: {
    name: "Màn 2: Nghị trường Cách mạng",
    subtitle: "Chương 3 & 4: CNXH & Thời kỳ Quá độ, Dân chủ & Nhà nước XHCN",
    targetXp: 600,
    timerPerQ: 20,
    env: "Quảng trường trung tâm, tòa nhà nghị sự quốc gia & băng rôn cờ đỏ",
  },
  3: {
    name: "Màn 3: Bản làng & Mái ấm Hiện đại",
    subtitle: "Chương 5, 6 & 7: Cơ cấu Xã hội - Giai cấp, Dân tộc, Tôn giáo & Gia đình",
    targetXp: 1000,
    timerPerQ: 15,
    env: "Thung lũng bản làng đa sắc màu, công trình tôn giáo & gia đình hiện đại",
  },
};

export const QUESTIONS_DATA: Question[] = [
  // ====================== LEVEL 1 (MÀN 1: CÔNG XƯỞNG THẾ KỶ XIX - CHƯƠNG 1 & 2) ======================
  {
    id: 1,
    level: 1,
    chapter: 1,
    category: "Chương 1: Nhập môn CNXH Khoa học",
  ...
  },
  {
    ...
    level: 1,
    chapter: 2,
    category: "Chương 2: Sứ mệnh Giai cấp Công nhân",
  ...
  // ====================== LEVEL 2 (MÀN 2: NGHỊ TRƯỜNG CÁCH MẠNG - CHƯƠNG 3 & 4) ======================
  {
    id: 21,
    level: 2,
    chapter: 3,
    category: "Chương 3: CNXH & Thời kỳ Quá độ",
  ...
  },
  {
    ...
    options: [
      "Sự tồn tại đan xem và đấu tranh giữa những nhân tố của xã hội mới và những tàn dư của xã hội cũ trên mọi lĩnh vực",
  ...
  },
  {
    ...
    level: 2,
    chapter: 4,
    category: "Chương 4: Dân chủ & Nhà nước XHCN",
  ...
  // ====================== LEVEL 3 (MÀN 3: BẢN LÀNG & MÁI ẤM HIỆN ĐẠI - CHƯƠNG 5, 6 & 7) ======================
  {
    id: 41,
    level: 3,
    chapter: 5,
    category: "Chương 5: Cơ cấu Xã hội - Giai cấp",
  ...
  },
  {
    ...
    level: 3,
    chapter: 6,
    category: "Chương 6: Vấn đề Dân tộc & Tôn giáo",
  ...
  },
  {
    ...
    level: 3,
    chapter: 7,
    category: "Chương 7: Vấn đề Gia đình XHCN",
